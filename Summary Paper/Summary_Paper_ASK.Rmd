...
crime = read.csv("C:\\Users\\HP\\Desktop\\Mid-Term Project ASK\\Crime_Data.csv")
...
summary(anova_lat)
```
Coorelation Analysis reveals that there is potential geographic patterns in crime distribution across different demographic groups in Los Angeles, which is useful but not able to able to find exact coorelation to the spatial relationships in crime patterns by victim descent.
